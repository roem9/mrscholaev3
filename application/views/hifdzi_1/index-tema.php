                        ...
                        <?php if($tema[$i]['status'] == "on"):?>
                            ...
                            <div class="card-header list-group-item-info d-flex justify-content-between"><?= $tema[$i]['title_arti']?><span class="badge badge-danger"><?= $tema[$i]['count']?></span></div>
                                <div class="card-body">
                                    ...
                                    <?php if($tema[$i]['mufrodat'] == 100) :?>
                                        <a href="<?= base_url()?>materi/program/a20deb514ea1ea62546f6474a5abe59c?tema=<?= MD5($tema[$i]['title_arti'])?>" class="btn btn-block btn-sm btn-success"><i class="fa fa-book mr-1"></i> Mulai</a>
                                    <?php else :?>
                                        <a href="<?= base_url()?>materi/program/a20deb514ea1ea62546f6474a5abe59c?tema=<?= MD5($tema[$i]['title_arti'])?>" class="btn btn-block btn-sm btn-secondary"><i class="fa fa-book mr-1"></i> Mulai</a>
                                    <?php endif;?>
                                </div>
                            </div>
                        </div>
