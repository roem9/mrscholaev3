        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-1">
                    <div class="alert alert-warning"><i class="fa fa-exclamation-circle text-warning mr-1"></i>Terjemahkan kalimat berikut ini ke dalam Bahasa Arab. Gunakan "<strong>-</strong>" untuk memisahkan kata</div>
                </div>
            </div>
            <?php 
                $urut = 0;
...
<script>
    ...
    $(".hapus").click(function(){
        ...
        } else if(answer.charAt(answer.length-1) == "ا" || answer.charAt(answer.length-1) == "-" || answer.charAt(answer.length-1) == "ل"){
