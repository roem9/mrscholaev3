        <div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-1">
                    <div class="alert alert-warning"><i class="fa fa-exclamation-circle text-warning mr-1"></i>Tentukan penggunaan <strong>ذٰلِكَ / تِلْكَ</strong> pada kata berikut ini</div>
                </div>
            </div>
                <?php 
                    $urut = 0;
