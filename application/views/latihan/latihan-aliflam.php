<div class="container">
            <div class="row">
                ...
                <div class="col-12 mb-1">
                    <div class="alert alert-warning"><i class="fa fa-exclamation-circle text-warning mr-1"></i>Tambahkan Alif Lam (<b>ال</b>) yang sesuai dengan kata-kata berikut ini, lalu pilih tombol <strong>pilih</strong> untuk menyimpan jawaban</div>
                </div>
            </div>
                <?php 
                    $urut = 0;
                            ...
                            <div id="select<?=$i?>">
                                <div class="container">
                                    <div class="row justify-content-center">
                                        <?php foreach ($mufrodat[$i]['kata'] as $k => $data) :?>
                                            <!-- <div class="col"> -->
