...
?> 
        ...
        <?php if(isset($kata)):?>
            ...
            <div class="row">
                <div class="col-12 col-md-12 mb-3">
                    <a href="<?= base_url()?>awwal/fiil/madhi" class="btn btn-sm btn-success"><i class="fa fa-arrow-left"></i> kembali</a>
                </div>
            </div>
        <?php else:?>
            <div class="row">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url()?>latihan/add_latihan" method="post" id="latihan">
                        ...
                        <input type="hidden" name="redirect" value="awwal/fiil/madhi">
