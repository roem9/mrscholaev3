    <div class="container">
        <div class="row">
            <div class="col-12 col-md-12 mb-3">
                <ul class="list-group">
                    <li class="list-group-item list-group-item-danger d-flex justify-content-between">Fi'il Mudhori</li>
                    <li class="list-group-item" id="baku">Fi'il Mudhori adalah kata kerja yang digunakan untuk menyatakan pekerjaan yang sedang atau akan dilakukan</li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-md-12 mb-3">
                <a href="<?= base_url()?>awwal/fiil" class="btn btn-sm btn-success text-light"><i class="fa fa-arrow-left"></i> Kembali</a>
            </div>
        </div>
        <div class="row">
                ...
                <div class="col-12 col-md-3 mb-3">
                    <div class="card shadow">
                        ...
                        <div class="card-body">
                            <div class="container">
                                <div class="row">
                                    <form action="<?= base_url()?>awwal/fiil/latihanmudhori" method="post">
