...
?> 
        <div class="container" id="container-content">
            <?php if(isset($kata)):?>
                ...
                <div class="row">
                    <div class="col-12 col-md-12 mb-3">
                        <a href="<?= base_url()?>fiil/madhi" class="btn btn-sm btn-success"><i class="fa fa-arrow-left"></i> kembali</a>
                    </div>
                </div>
            <?php else:?>
                <div class="row">
        ...
        <div class="modal fade" id="modalDhomir" tabindex="-1" role="dialog" aria-labelledby="modalDhomirLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?= base_url()?>latihan/latihan3" method="post" id="latihan">
