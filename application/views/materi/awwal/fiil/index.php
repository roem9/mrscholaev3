                ...
                <div class="col-12 col-md-4 mb-3">
                    <?php if($madhi < 30):?>
                        <div class="card border-danger">
                            ...
                            <div class="card-body">
                                <a href="<?= base_url()?>awwal/fiil/madhi" class="btn btn-block btn-sm btn-danger"><i class="fa fa-book mr-1"></i> Mulai Belajar</a>
                            </div>
                        </div>
                    <?php else:?>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="<?= base_url()?>awwal/fiil/madhi" class="btn btn-block btn-sm btn-success"><i class="fa fa-book mr-1"></i> Mulai Belajar</a>
                            </div>
                        </div>
                    <?php endif;?>
                </div>
                <div class="col-12 col-md-4 mb-3">
                    <?php if($mudhori < 30):?>
                        <div class="card border-danger">
                            ...
                            <div class="card-body">
                                <a href="<?= base_url()?>awwal/fiil/mudhori" class="btn btn-block btn-sm btn-danger"><i class="fa fa-book mr-1"></i> Mulai Belajar</a>
                            </div>
                        </div>
                    <?php else:?>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="<?= base_url()?>awwal/fiil/mudhori" class="btn btn-block btn-sm btn-success"><i class="fa fa-book mr-1"></i> Mulai Belajar</a>
                            </div>
                        </div>
                    <?php endif;?>
                </div>
                <div class="col-12 col-md-4 mb-3">
                    <?php if($amr < 30):?>
                        <div class="card border-danger">
                            ...
                            <div class="card-body">
                                <a href="<?= base_url()?>awwal/fiil/amr" class="btn btn-block btn-sm btn-danger"><i class="fa fa-book mr-1"></i> Mulai Belajar</a>
                            </div>
                        </div>
                    <?php else:?>
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="<?= base_url()?>awwal/fiil/amr" class="btn btn-block btn-sm btn-success"><i class="fa fa-book mr-1"></i> Mulai Belajar</a>
                            </div>
                        </div>
                    <?php endif;?>
                </div>
