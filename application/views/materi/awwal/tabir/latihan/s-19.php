...
?>
        <div class="container">
            ...
            <div class="row">
                <?php 
                    $urut = 0;
                    foreach ($soal as $i => $kalimat) :
                    $urut++?>

                    <div class="col-12 col-md-12 mb-3">
                        <div class="form-group">
                            <div class="text-right">
                                <label style="display:block" for="<?=$i?>"><?= $kalimat['dhomir']?> <span class="text-right" id="j<?=$i?>"></span></label>
                            </div>
                            <input type="hidden" name="kunci<?=$i?>" value="<?= $kalimat['ket']?>">
            ...
            <div class="row">
                <form action="<?= base_url()?>latihan/add_latihan" method="post" id="latihan">
                    ...
                    <input type="hidden" name="hal" value="s-19">
                    <input type="hidden" name="materi" value="attabir">
                    <input type="hidden" name="latihan" value="<?= $materi['latihan']?>">
                    <input type="hidden" name="redirect" value="awwal/ungkapan/s-19">
                </form>
                <div class="col-12 col-md-12 mb-3">
                    <a id="simpanJawaban" data-id="<?= COUNT($soal)?>" class="btn btn-block btn-primary text-light">Simpan</a>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    $("#backHome").click(function(){
        Swal.fire({
            ...
            confirmButtonText: '<a href="<?= base_url()?>awwal/ungkapan/s-19">Ya</a>',
