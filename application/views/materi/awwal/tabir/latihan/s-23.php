        <div class="container">
                    ...
                    <div class="col-12 col-md-12 mb-3">
                        <div class="form-group">
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex justify-content-end">
                                  <span><?= $kalimat['isim'][0]?> <span id="j<?=$i?>">.........</span> <?= $kalimat['isim'][1]?></span>
                                </li>
                            </ul>
            ...
            <div class="row">
                <form action="<?= base_url()?>latihan/add_latihan" method="post" id="latihan">
                    ...
                    <input type="hidden" name="hal" value="s-23">
                    <input type="hidden" name="materi" value="attabir">
                    <input type="hidden" name="latihan" value="<?= $latihan?>">
                    <input type="hidden" name="redirect" value="awwal/ungkapan/s-23">
                </form>
                <div class="col-12 col-md-12 mb-3">
...
<script>
    ...
    $("#backHome").click(function(){
        Swal.fire({
            ...
            confirmButtonText: '<a href="<?= base_url()?>awwal/ungkapan/s-23">Ya</a>',
