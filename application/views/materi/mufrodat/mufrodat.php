                ...
                <?php if(COUNT($mufrodat) != 0):?>
                    <?php foreach ($mufrodat as $mufrodat) :?>
                        <div class="col-12 col-md-4 mb-2">
                            <ul class="list-group shadow">
                                <li class="list-group-item d-flex justify-content-between" id="container-content">
                    ...
                    <div class="col-12">
                        <ul class="list-group">
                            ...
                            <?php if($latihan[0]):?>
                                <li class="list-group-item"><a href="<?= base_url()?>kosakata/latihan/1/<?= $mufrodat['id_mufrodat']?>" class="btn btn-sm btn-block btn-success">Latihan 1</a></li>
                            <?php else :?>
                                <li class="list-group-item"><a href="<?= base_url()?>kosakata/latihan/1/<?= $mufrodat['id_mufrodat']?>" class="btn btn-sm btn-block btn-danger">Latihan 1</a></li>
                            <?php endif;?>
                            <?php if($latihan[1]):?>
                                <li class="list-group-item"><a href="<?= base_url()?>kosakata/latihan/2/<?= $mufrodat['id_mufrodat']?>" class="btn btn-sm btn-block btn-success">Latihan 2</a></li>
                            <?php else :?>
                                <li class="list-group-item"><a href="<?= base_url()?>kosakata/latihan/2/<?= $mufrodat['id_mufrodat']?>" class="btn btn-sm btn-block btn-danger">Latihan 2</a></li>
                            <?php endif;?>
                        </ul>
                    </div>
                <?php else :?>
