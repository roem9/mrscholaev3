        <div class="container">
            <div class="row">
                <div class="col-12 mb-3">
                    <a href="<?= base_url()?>mufrodat" class="text-primary"><u>Materi</u></a> / <a class="text-primary" href="<?= base_url()?>mufrodat?tema=<?= md5($tema)?>"><u><?= $tema?></u></a> / <a class="text-primary" href="<?= base_url()?>mufrodat?id=<?= md5($materi)?>"><u><?= $title?></u></a>
