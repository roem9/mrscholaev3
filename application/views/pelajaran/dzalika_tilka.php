            ...
            <div class="row">
                ...
                <?php if(!empty($latihan[0]) && !empty($latihan[1]) && !empty($latihan[2]) && !empty($latihan[3])):?>
                    <div class="col-12 mb-1">
                        <div class="alert alert-success" style="font-size: 14px"><i class="fa fa-check-circle mr-1 text-success"></i>Anda telah menyelesaikan pelajaran Itu</div>
                    </div>
                <?php endif;?>
                <div class="col-12">
                    <div class="alert alert-warning"><i class="fa fa-exclamation-circle text-warning mr-1"></i><strong>ذٰلِكَ / تِلْكَ</strong> memilik arti <strong>itu</strong>. <strong>ذٰلِكَ</strong> diperuntukkan untuk <strong>مُذَكَّرٌ</strong> dan <strong>تِلْكَ</strong> diperuntukkan untuk <strong>مُؤَنَّثٌ</strong></div>
                </div>
                <div class="col-12 mb-3">
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-success">Penggunaan kata <strong>ذٰلِكَ</strong></li>
                        <li class="list-group-item d-flex justify-content-between container-content arab">
                            <a class="" data-container="body" data-toggle="popover" data-placement="top" data-content="Itu adalah Buku">
                                <i class="fa fa-info-circle text-info fa-lg"></i>
                            </a>
                            <span>ذٰلِكَ كِتَـابٌ</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between container-content arab">
                            <a class="" data-container="body" data-toggle="popover" data-placement="top" data-content="Itu adalah Asrama">
                                <i class="fa fa-info-circle text-info fa-lg"></i>
                            </a>
                            <span>ذٰلِكَ سَكَنٌ</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between container-content arab">
                            <a class="" data-container="body" data-toggle="popover" data-placement="top" data-content="Itu adalah Pintu">
                                <i class="fa fa-info-circle text-info fa-lg"></i>
                            </a>
                            <span>ذٰلِكَ بَابٌ</span>
                        </li>
                    </ul>
                </div>
                <div class="col-12 mb-3">
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-success">Penggunaan kata <strong>تِلْكَ</strong></li>
                        <li class="list-group-item d-flex justify-content-between container-content arab">
                            <a class="" data-container="body" data-toggle="popover" data-placement="top" data-content="Itu adalah Jendela">
                                <i class="fa fa-info-circle text-info fa-lg"></i>
                            </a>
                            <span>تِلْكَ نَافِذَةٌ</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between container-content arab">
                            <a class="" data-container="body" data-toggle="popover" data-placement="top" data-content="Itu adalah Jam">
                                <i class="fa fa-info-circle text-info fa-lg"></i>
                            </a>
                            <span>تِلْكَ سَاعَةٌ</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between container-content arab">
                            <a class="" data-container="body" data-toggle="popover" data-placement="top" data-content="Itu adalah Kamar">
                                <i class="fa fa-info-circle text-info fa-lg"></i>
                            </a>
                            <span>تِلْكَ غُرْفَةٌ</span>
                        </li>
                    </ul>
                </div>
                <div class="col-12">
